...
public class ReqBodySecurity {
        ...
        @NotNull(message = "verificationCode is mandatory", groups = {
                        ValidationSecurity.validateVerificationCode.class })
        @JsonProperty("verificationCode")
        String verificationCode;

        @NotNull(message = "pin is mandatory", groups = { ValidationSecurity.assignPin.class,
                        ValidationSecurity.validatePin.class,
        ...
        @NotNull(message = "cardId is mandatory", groups = { ValidationSecurity.assignPin.class,
                        ValidationSecurity.validatePin.class,
                        ValidationSecurity.editPin.class, ValidationSecurity.addPinLog.class })
        @JsonProperty("cardId")
        String cardId;
